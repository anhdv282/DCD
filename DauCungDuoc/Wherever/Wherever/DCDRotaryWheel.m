...
- (void) drawWheel {
    ...
    for (int i = 0; i < numberOfSections; i++) {
        ...
        UIImageView *im = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"segment8"]];
        [im setFrame:CGRectMake(0, 0, im.frame.size.width*0.6, im.frame.size.height*0.6)];
...
//        }
    ...
    bg.image = [UIImage imageNamed:@"rollBg"];
    [self addSubview:bg];
...
- (void) buildClovesEven {
    ...
    for (int i = 0; i < numberOfSections; i++) {
        ...
        DCDCLove *clove = [[DCDCLove alloc] init];
        clove.midValue = mid;
